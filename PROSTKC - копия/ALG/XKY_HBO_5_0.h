...
typedef struct
{
 double	period; /* оскулирующий период                      */
 double	hper;   /* оскулирующая высота перигея              */
 double	i;      /* наклонение орбиты             (град)     */
 double	om;     /* инерциальная долгота ВУО      (град)     */
 double	teta;   /* ист. аномалия                 (град)     */
 double	wper;   /* аргумент перигея              (град)     */
}P_Orb;
