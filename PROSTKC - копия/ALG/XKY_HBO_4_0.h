...
extern void KORIN_E(KU_TimeDATA t_begin,KU_TimeDATA t_end,Finp_E a,
		     double (*prcd)(Finp_E a),int *N,double MI[5][2]);
extern void KORXB_E(KU_TimeDATA t_begin,KU_TimeDATA t_end,Finp_E a,double (*prcd)(Finp_E a),
		     int *CR,double X[10],int *IN);
extern void KORIN_Ed(double begin, double end, Finp_E a, double (*prcd)(Finp_E a),
			  int *N, double MI[5][2]);
extern void KORXB_Ed(double begin, double end, Finp_E a, double (*prcd)(Finp_E a),
		      int *CR, double X[10], int *IN);
...
extern void maAvmaB(double A[][3],double B[][3]);
