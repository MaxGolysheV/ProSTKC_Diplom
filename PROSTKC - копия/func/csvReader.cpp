...
extern int maxKa;//текущее количество аппаратов в фале. Оригинальная переменная находится в Unit1.cpp(главная форма)
...
void readEOF(AnsiString path,TForm1 *form1, Kosmo ka[])
{
	...
	waste1,waste1,waste1,waste1,waste1,waste1,waste1,waste1,waste1,waste1,waste1,waste1,waste1);
