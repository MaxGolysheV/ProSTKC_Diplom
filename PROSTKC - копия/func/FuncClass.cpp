...
#include "Strukts.h"
//функция формирует статистику ви виде графика (Graph2.cpp)
...
//функция для отображения трассы
//входнвые жданные
//векторы
//сутки и секунды пирвязки
//дата расчета
//шаг при построении графика (=60)
//форма с графиком
...
//тут вся магия построения трассы КА
